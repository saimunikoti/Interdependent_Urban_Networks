...
#                            (2, 82, 1), (2, 84, 1), (3, 60, 1), (3, 61, 1), (3, 62, 1), (3, 63, 1), (3, 64, 1),
#                            (3, 66, 1), (3, 67, 1), (3, 68, 1),
#                            (5, 36, 1), (5, 37, 1), (5, 38, 1), (5, 39, 1), (5, 41, 1), (7, 101, 1), (7, 102, 1),
#                            (7, 103, 1), (7, 106, 1), (7, 107, 1), (7, 108, 1),
#                            (8, 26, 0.5), (10, 85, 1), (10, 86, 1), (10, 88, 1), (10, 89, 1), (11, 69, 1), (11, 74, 1),
#                            (11, 75, 1), (11, 78, 1), (11, 79, 1), (14, 27, 0.5),
#                            (15, 35, 1), (15, 42, 1), (15, 43, 1), (15, 44, 1), (15, 46, 1), (15, 47, 1), (15, 48, 1),
#                            (15, 49, 1), (15, 50, 1), (15, 51, 1), (15, 52, 1), (15, 53, 1), (15, 55, 1),
#                            (18, 90, 1), (18, 91, 1), (18, 92, 1), (18, 93, 1), (18, 94, 1),
#                            (21, 100, 1), (21, 104, 1), (21, 105, 1), (21, 109, 1), (21, 110, 1), (21, 111, 1),
#                            (23, 28, 0.5),
#                            (34, 31, 0.5), (35, 3, 0.2), (35, 26, 0.1), (36, 3, 0.8), (36, 26, 0.4), (37, 4, 0.3),
#                            (38, 6, 0.5), (39, 7, 0.7), (39, 28, 0.35),
#                            (40, 34, 1), (41, 9, 0.5), (43, 12, 0.6), (44, 13, 0.3), (46, 16, 0.5), (47, 17, 0.3),
#                            (48, 19, 0.3), (49, 20, 0.4), (50, 21, 0.8), (50, 33, 0.4), (51, 22, 0.4), (52, 24, 0.4),
#                            (53, 11, 1), (53, 30, 0.5),
#                            (54, 29, 0.5), (55, 4, 0.2), (56, 30, 0.5), (57, 33, 0.5), (58, 32, 0.5), (59, 14, 0.5),
#                            (60, 2, 0.5), (60, 25, 0.25),
#                            (61, 4, 0.3), (62, 5, 0.5), (62, 27, 0.25), (63, 6, 0.3), (64, 7, 0.3), (64, 28, 0.15),
#                            (65, 56, 0.5), (66, 9, 0.3),
#                            (67, 10, 0.5), (67, 29, 0.25), (68, 12, 0.2), (69, 13, 0.3), (70, 1, 0.5), (71, 15, 1),
#                            (71, 31, 0.5),
#                            (72, 16, 0.3), (73, 17, 0.3), (74, 18, 0.5), (74, 32, 0.25), (75, 19, 0.3), (76, 20, 0.3),
#                            (77, 21, 0.20), (77, 33, 0.1),
#                            (78, 22, 0.3), (79, 24, 0.2), (80, 57, 0.5), (81, 4, 0.2), (82, 6, 0.2), (83, 57, 0.5),
#                            (84, 9, 0.2), (85, 12, 0.2),
#                            (86, 13, 0.1), (87, 58, 1), (88, 16, 0.2), (89, 17, 0.1), (90, 19, 0.1), (91, 20, 0.3),
#                            (93, 22, 0.30), (94, 24, 0.3),
#                            (95, 1, 0.5), (96, 54, 1), (97, 8, 1), (98, 56, 0.5), (99, 14, 0.5), (100, 24, 0.1),
#                            (101, 2, 0.5), (101, 25, 0.25), (102, 5, 0.5), (102, 27, 0.25), (103, 10, 0.5),
#                            (103, 29, 0.25), (104, 18, 0.5), (104, 32, 0.25),
...
G.add_weighted_edges_from([(95, 1, 0.5), (70, 1, 0.5), (60, 2, 0.5), (101, 2, 0.5), (1, 25, 0.5), (2, 81, 1),
                           ...
                           (95, 1, 0.5), (96, 54, 1), (97, 8, 1), (98, 56, 0.5), (99, 14, 0.5), (100, 24, 0.1),
                           (101, 2, 0.5), (101, 25, 0.25), (102, 5, 0.5), (102, 27, 0.25), (103, 10, 0.5),
                           (103, 29, 0.25), (104, 18, 0.5), (104, 32, 0.25),(105,112,1),(105,113,0.5),
                           (106, 13, 0.3), (107, 17, 0.3), (108, 19, 0.3),
                           (114,113,0.5),(112,115,1),(112,116,1),(112,117,1),(112,118,1),(112,119,1),(112,120,1),(112,121,1)])
...
d = dict(G.degree)
nodes = nx.draw_networkx_nodes(G, pos, with_labels=True, node_size=[v * 100 for v in d.values()],
...
def get_initialattr(G):
    ...
    for (node, val) in G.degree(weight='weight'):
        G.nodes[node]['qo'] = val
        G.nodes[node]['crf'] = 1
        G.nodes[node]['orgnodecount'] = noofnodes
